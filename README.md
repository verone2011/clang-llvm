...
You can see information about the latest greenforce clang build in clang-18.0.0-04092023-0706-info.txt, the latest tag is 04092023 (see latest.txt). To use greenforce clang, you can download it directly from the git releases, or you can follow the simple commands below:
...
GREENFORCE_LINK=https://github.com/greenforce-project/clang-llvm/releases/download/04092023/greenforce-clang-18.0.0-04092023-0706.tar.gz
